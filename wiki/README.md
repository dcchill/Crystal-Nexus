...
1. [Getting Started and Progression](getting-started.md)
2. [Energy and Power](energy-and-power.md)
3. [Processing Machines](processing-machines.md)
4. [Logistics and Storage](logistics-and-storage.md)
5. [Resources and Materials](resources-and-materials.md)
6. [Tools, Equipment, and Utility Items](tools-and-equipment.md)
7. [Multiblocks and Late Game](multiblocks-and-late-game.md)
8. [Automation Notes](automation-notes.md)
...
4. Advance through Crystal, Titanium, Carbon, Titanium Carbide, Tungsten, and Hyper technology.
5. Build logistics, factories, reactors, accelerators, quarries, and late-game multiblocks.

## Documentation Conventions

- FE means Forge Energy.
- JEI is still the best place to check exact recipes.
- Machine input/output slot counts are listed only where the machine exposes them clearly.
