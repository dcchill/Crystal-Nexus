...
public class OreCrushingJeiRecipeCategory implements IRecipeCategory<OreCrushingJeiRecipe> {
	public final static ResourceLocation UID = ResourceLocation.parse("crystalnexus:ore_crushing_jei");
	...
	public OreCrushingJeiRecipeCategory(IGuiHelper helper) {
		this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 85);
		this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(CrystalnexusModBlocks.CRYSTAL_CRUSHER.get().asItem()));
	}

	@Override
	public mezz.jei.api.recipe.RecipeType<OreCrushingJeiRecipe> getRecipeType() {
		return CrystalnexusModJeiPlugin.OreCrushingJei_Type;
	}

	@Override
	public Component getTitle() {
		return Component.literal("Ore Crushing");
	}
