...
public class ChemicalReactionRecipe implements Recipe<RecipeInput> {
	private final ItemStack output;
	private final NonNullList<Ingredient> recipeItems;

	public ChemicalReactionRecipe(ItemStack output, NonNullList<Ingredient> recipeItems) {
		this.output = output;
	...
	public static class Type implements RecipeType<ChemicalReactionRecipe> {
		private Type() {
		}

		public static final RecipeType<ChemicalReactionRecipe> INSTANCE = new Type();
	}

	public static class Serializer implements RecipeSerializer<ChemicalReactionRecipe> {
		public static final Serializer INSTANCE = new Serializer();
		private static final MapCodec<ChemicalReactionRecipe> CODEC = RecordCodecBuilder
				...
				}, DataResult::success).forGetter(recipe -> recipe.recipeItems)).apply(builder, ChemicalReactionRecipe::new));
		public static final StreamCodec<RegistryFriendlyByteBuf, ChemicalReactionRecipe> STREAM_CODEC = StreamCodec.of(Serializer::toNetwork, Serializer::fromNetwork);
		...
		private static ChemicalReactionRecipe fromNetwork(RegistryFriendlyByteBuf buf) {
			...
			return new ChemicalReactionRecipe(ItemStack.STREAM_CODEC.decode(buf), inputs);
		}

		private static void toNetwork(RegistryFriendlyByteBuf buf, ChemicalReactionRecipe recipe) {
