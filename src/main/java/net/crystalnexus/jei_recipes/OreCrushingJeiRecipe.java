...
public class OreCrushingJeiRecipe implements Recipe<RecipeInput> {
	...
	public static class Type implements RecipeType<OreCrushingJeiRecipe> {
		private Type() {
		}

		public static final RecipeType<OreCrushingJeiRecipe> INSTANCE = new Type();
	}

	public static class Serializer implements RecipeSerializer<OreCrushingJeiRecipe> {
		public static final Serializer INSTANCE = new Serializer();
		private static final MapCodec<OreCrushingJeiRecipe> CODEC = RecordCodecBuilder
		...
		@Override
		public MapCodec<OreCrushingJeiRecipe> codec() {
			return CODEC;
		}

		@Override
		public StreamCodec<RegistryFriendlyByteBuf, OreCrushingJeiRecipe> streamCodec() {
			return STREAM_CODEC;
		}
