...
public enum MachineTier {
    ...
    TITANIUM(2, 0.75, 2.00, "Titanium"),
    CARBON(3, 0.50, 4.00, "Carbon"),
    TITANIUM_CARBIDE(4, 0.40, 8.00, "Titanium Carbide"),
    TUNGSTEN(5, 0.35, 16.00, "Tungsten"),
    HYPER(6, 0.30, 32.00, "Hyper");
