...
public record CrusherGuiSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final Type<CrusherGuiSlotMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(CrystalnexusMod.MODID, "crusher_gui_slots"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CrystalnexusMod.addNetworkMessage(CrusherGuiSlotMessage.TYPE, CrusherGuiSlotMessage.STREAM_CODEC, CrusherGuiSlotMessage::handleData);
	}
}