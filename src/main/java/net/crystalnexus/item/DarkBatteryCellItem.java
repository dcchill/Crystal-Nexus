...
public class DarkBatteryCellItem extends Item {
    public static int capacity() {
        return CrystalnexusConfig.ITEMS.DARK_BATTERY_CELL.capacity();
    }

    public static int maxReceive() {
        return CrystalnexusConfig.ITEMS.DARK_BATTERY_CELL.maxReceive();
    }

    public static int maxExtract() {
        return CrystalnexusConfig.ITEMS.DARK_BATTERY_CELL.maxExtract();
    }
