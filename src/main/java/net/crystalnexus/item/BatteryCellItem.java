...
public class BatteryCellItem extends Item {
    public static int capacity() {
        return CrystalnexusConfig.ITEMS.BATTERY_CELL.capacity();
    }

    public static int maxReceive() {
        return CrystalnexusConfig.ITEMS.BATTERY_CELL.maxReceive();
    }

    public static int maxExtract() {
        return CrystalnexusConfig.ITEMS.BATTERY_CELL.maxExtract();
    }
