...
public class DenseBatteryCellItem extends Item {
    public static int capacity() {
        return CrystalnexusConfig.ITEMS.DENSE_BATTERY_CELL.capacity();
    }

    public static int maxReceive() {
        return CrystalnexusConfig.ITEMS.DENSE_BATTERY_CELL.maxReceive();
    }

    public static int maxExtract() {
        return CrystalnexusConfig.ITEMS.DENSE_BATTERY_CELL.maxExtract();
    }

    public DenseBatteryCellItem() {
