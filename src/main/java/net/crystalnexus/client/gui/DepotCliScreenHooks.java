...
public final class DepotCliScreenHooks {
    ...
    public static void handle(S2C_DepotProgramResponse packet) {
        if (Minecraft.getInstance().screen instanceof DepotCliScreen screen) screen.handleProgramResponse(packet);
    }
}
