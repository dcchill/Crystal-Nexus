...
public class SeparatorGuiScreen extends AbstractContainerScreen<SeparatorGuiMenu> implements CrystalnexusModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;

	public SeparatorGuiScreen(SeparatorGuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("crystalnexus:textures/screens/separator_gui.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + -22 && mouseX < leftPos + 2 && mouseY > topPos + 9 && mouseY < topPos + 33) {
			String hoverText = DustSeparatorOnTickUpdateProcedure.execute(world, x, y, z);
			if (hoverText != null) {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.separator_gui.label_proc_get_block_name_for_gui"), 73, -10, -12829636, false);
	}
