...
public class CrusherGuiScreen extends AbstractContainerScreen<CrusherGuiMenu> implements CrystalnexusModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("crystalnexus:textures/screens/crusher_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.crusher_gui.label_proc_get_block_name_for_gui"), 59, -10, -12829636, false);
	}
