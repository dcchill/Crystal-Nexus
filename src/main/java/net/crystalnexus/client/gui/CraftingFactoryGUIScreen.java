...
public class CraftingFactoryGUIScreen extends AbstractContainerScreen<CraftingFactoryGUIMenu> implements CrystalnexusModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;

	public CraftingFactoryGUIScreen(CraftingFactoryGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("crystalnexus:textures/screens/crafting_factory_gui.png");

	@Override
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		super.render(guiGraphics, mouseX, mouseY, partialTicks);
		boolean customTooltipShown = false;
		if (mouseX > leftPos + 129 && mouseX < leftPos + 153 && mouseY > topPos + 32 && mouseY < topPos + 56) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.crystalnexus.crafting_factory_gui.tooltip_crafting_filter"), mouseX, mouseY);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.crafting_factory_gui.label_crafting_factory"), 66, -10, -12829636, false);
	}
