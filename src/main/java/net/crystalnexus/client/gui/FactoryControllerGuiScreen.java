...
public class FactoryControllerGuiScreen extends AbstractContainerScreen<FactoryControllerGuiMenu> implements CrystalnexusModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;

	public FactoryControllerGuiScreen(FactoryControllerGuiMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(ResourceLocation.parse("crystalnexus:textures/screens/factory_controller_gui_colored.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 176, 166, 176, 166);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.factory_controller_gui.label_factory_energy_controller"), 63, -10, -12829636, false);
	}
