...
public class BlockPlacerGuiScreen extends AbstractContainerScreen<BlockPlacerGuiMenu> implements CrystalnexusModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("crystalnexus:textures/screens/block_placer_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.block_placer_gui.label_block_placer"), 77, -10, -12829636, false);
	}
