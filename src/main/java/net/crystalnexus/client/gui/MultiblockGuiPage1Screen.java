...
public class MultiblockGuiPage1Screen extends AbstractContainerScreen<MultiblockGuiPage1Menu> implements CrystalnexusModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.multiblock_gui_page_1.label_blutonium_reactor"), 141, 7, -3407668, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.multiblock_gui_page_1.label_uses_water_and_blutonium_ingots"), 141, 25, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.multiblock_gui_page_1.label_to_create_fe"), 141, 34, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.multiblock_gui_page_1.label_without_water_or_a_permafreeze_u"), 141, 52, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.multiblock_gui_page_1.label_upgrade_the_reactor_can_gain"), 141, 61, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.multiblock_gui_page_1.label_too_much_heat_and_meltdown"), 141, 70, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.multiblock_gui_page_1.label_the_fluid_input_and_energy_outpu"), 141, 88, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.multiblock_gui_page_1.label_blocks_are_interchangeable"), 141, 97, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.crystalnexus.multiblock_gui_page_1.label_long_as_you_have_both"), 141, 106, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_tab_dark = new ImageButton(this.leftPos + 285, this.topPos + -23, 32, 26, new WidgetSprites(ResourceLocation.parse("crystalnexus:textures/screens/tab_dark.png"), ResourceLocation.parse("crystalnexus:textures/screens/tab.png")),
				e -> {
					...
					int y = MultiblockGuiPage1Screen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new MultiblockGuiPage1ButtonMessage(2, x, y, z));
						MultiblockGuiPage1ButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
		...
		imagebutton_tab_dark1 = new ImageButton(this.leftPos + 252, this.topPos + -23, 32, 26,
				new WidgetSprites(ResourceLocation.parse("crystalnexus:textures/screens/tab_orepro_dark.png"), ResourceLocation.parse("crystalnexus:textures/screens/tab_orepro.png")), e -> {
					...
					int y = MultiblockGuiPage1Screen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new MultiblockGuiPage1ButtonMessage(3, x, y, z));
						MultiblockGuiPage1ButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_tab_dark2 = new ImageButton(this.leftPos + 219, this.topPos + -23, 32, 26,
				new WidgetSprites(ResourceLocation.parse("crystalnexus:textures/screens/tab_ultimasmelter_dark.png"), ResourceLocation.parse("crystalnexus:textures/screens/tab_ultimasmelter.png")), e -> {
					...
					int y = MultiblockGuiPage1Screen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new MultiblockGuiPage1ButtonMessage(4, x, y, z));
						MultiblockGuiPage1ButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_tab_dark3 = new ImageButton(this.leftPos + 186, this.topPos + -23, 32, 26,
				new WidgetSprites(ResourceLocation.parse("crystalnexus:textures/screens/tab_reaction_dark.png"), ResourceLocation.parse("crystalnexus:textures/screens/tab_reaction.png")), e -> {
					...
					int y = MultiblockGuiPage1Screen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new MultiblockGuiPage1ButtonMessage(5, x, y, z));
						MultiblockGuiPage1ButtonMessage.handleButtonAction(entity, 5, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
