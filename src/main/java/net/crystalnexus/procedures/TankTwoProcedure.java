...
public class TankTwoProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		if (getFluidTankLevel(world, BlockPos.containing(x, y, z), 1, null) >= 2000 && getFluidTankLevel(world, BlockPos.containing(x, y, z), 1, null) < 3000) {
			return true;
		}
		return false;
	}
