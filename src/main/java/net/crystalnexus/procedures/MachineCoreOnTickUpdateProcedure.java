...
public class MachineCoreOnTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		double fePt = 0;
		double energy = 0;
		computer = CrystalnexusModBlocks.ORE_PROCESSOR.get().defaultBlockState();
		output = CrystalnexusModBlocks.MACHINE_ENERGY_INPUT.get().defaultBlockState();
		...
		if ((world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock() == output.getBlock()) {
			if (getMaxEnergyStored(world, BlockPos.containing(x + computerX, y, z + computerZ), null) != getEnergyStored(world, BlockPos.containing(x + computerX, y, z + computerZ), null)) {
				energy = extractEnergySimulate(world, BlockPos.containing(x + 1, y, z), 128000, null);
			...
			if (getMaxEnergyStored(world, BlockPos.containing(x + computerX, y, z + computerZ), null) != getEnergyStored(world, BlockPos.containing(x + computerX, y, z + computerZ), null)) {
				energy = extractEnergySimulate(world, BlockPos.containing(x, y, z + 1), 128000, null);
				energy = receiveEnergySimulate(world, BlockPos.containing(x + computerX, y, z + computerZ), (int) energy, null);
