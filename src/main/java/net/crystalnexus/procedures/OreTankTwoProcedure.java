...
public class OreTankTwoProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		if (getFluidTankLevel(world, BlockPos.containing(x, y, z), 1, null) >= 10000 && getFluidTankLevel(world, BlockPos.containing(x, y, z), 1, null) < 20000) {
			return true;
		}
		return false;
	}
