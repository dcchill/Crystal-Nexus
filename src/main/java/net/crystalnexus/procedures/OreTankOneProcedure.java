...
public class OreTankOneProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		if (getFluidTankLevel(world, BlockPos.containing(x, y, z), 1, null) >= 1000 && getFluidTankLevel(world, BlockPos.containing(x, y, z), 1, null) < 10000) {
			return true;
		}
		return false;
	}
