...
public class Fluid2DisplayProcedure {
	public static double execute(LevelAccessor world, double x, double y, double z) {
		return (getFluidTankLevel(world, BlockPos.containing(x, y, z), 2, null) / (getFluidTankCapacity(world, BlockPos.containing(x, y, z), 2, null) * 0.9)) * 10;
	}
