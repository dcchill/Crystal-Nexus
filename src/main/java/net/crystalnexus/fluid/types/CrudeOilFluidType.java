...
public class CrudeOilFluidType extends FluidType {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("crystalnexus:block/oil_still");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("crystalnexus:block/oil_flow");
		...
		}, CrystalnexusModFluidTypes.CRUDE_OIL_TYPE.get());
	}
}