...
public class SteamFluidType extends FluidType {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("crystalnexus:block/steam_still");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("crystalnexus:block/steam_flowing");
		...
		}, CrystalnexusModFluidTypes.STEAM_TYPE.get());
	}
}