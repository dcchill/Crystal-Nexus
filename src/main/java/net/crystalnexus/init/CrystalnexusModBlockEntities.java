...
import net.crystalnexus.block.entity.TemporalExploiterBlockEntity;
...
public class CrystalnexusModBlockEntities {
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> ASSEMBLY_LINE_CONTROLLER = register("assembly_line_controller", CrystalnexusModBlocks.ASSEMBLY_LINE_CONTROLLER, net.crystalnexus.block.entity.AssemblyLineControllerBlockEntity::new);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> MAW = register("maw", CrystalnexusModBlocks.MAW, net.crystalnexus.block.entity.MawBlockEntity::new);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> CIRCUIT_PRESS = registerMany("circuit_press", CircuitPressBlockEntity::new,
			CrystalnexusModBlocks.CIRCUIT_PRESS, CrystalnexusModBlocks.TITANIUM_CARBIDE_CIRCUIT_PRESS);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> CHLOROPHYTE_SOLAR_PANEL = register("chlorophyte_solar_panel", CrystalnexusModBlocks.CHLOROPHYTE_SOLAR_PANEL, ChlorophyteSolarPanelBlockEntity::new);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> MEGA_CHEMICAL_REACTION_CHAMBER = register("mega_chemical_reaction_chamber", CrystalnexusModBlocks.MEGA_CHEMICAL_REACTION_CHAMBER, MegaChemicalReactionChamberBlockEntity::new);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> MACHINE_ENERGY_OUTPUT = register("machine_energy_output", CrystalnexusModBlocks.MACHINE_ENERGY_OUTPUT, MachineEnergyOutputBlockEntity::new);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> CRAFTING_FACTORY = registerMany("crafting_factory", CraftingFactoryBlockEntity::new,
			CrystalnexusModBlocks.CRAFTING_FACTORY, CrystalnexusModBlocks.CRYSTAL_CRAFTING_FACTORY, CrystalnexusModBlocks.TITANIUM_CRAFTING_FACTORY,
			CrystalnexusModBlocks.HYPER_CRAFTING_FACTORY);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> DEPOT_CABLE = register("depot_cable", CrystalnexusModBlocks.DEPOT_CABLE, DepotCableBlockEntity::new);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> CRAFTING_CORE = register("crafting_core", CrystalnexusModBlocks.CRAFTING_CORE, CraftingCoreBlockEntity::new);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> OXYGEN_COLLECTOR = register("atmosphere_collector", CrystalnexusModBlocks.OXYGEN_COLLECTOR, OxygenCollectorBlockEntity::new);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> CRYSTAL_TANK = register("crystal_tank", CrystalnexusModBlocks.CRYSTAL_TANK, CrystalTankBlockEntity::new);
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> DIESEL_GENERATOR_CONTROLLER = register("diesel_generator_controller", CrystalnexusModBlocks.DIESEL_GENERATOR_CONTROLLER,
			GasolineGeneratorControllerBlockEntity::new);
	...
	public static void registerCapabilities(RegisterCapabilitiesEvent event) {
		...
		event.registerBlockEntity(Capabilities.ItemHandler.BLOCK, CRYSTAL_CRUSHER.get(), (blockEntity, side) -> new net.crystalnexus.assembly.AssemblyLineItemHandler(blockEntity, side));
		...
		event.registerBlockEntity(Capabilities.ItemHandler.BLOCK, MAW.get(), (blockEntity, side) -> new SidedInvWrapper((WorldlyContainer) blockEntity, side));
		...
		event.registerBlockEntity(Capabilities.ItemHandler.BLOCK, ARC_FURNACE.get(), (blockEntity, side) -> new SidedInvWrapper((WorldlyContainer) blockEntity, side));
		event.registerBlockEntity(Capabilities.EnergyStorage.BLOCK, ARC_FURNACE.get(), (blockEntity, side) -> ((ArcFurnaceBlockEntity) blockEntity).getEnergyStorage());
		event.registerBlockEntity(Capabilities.ItemHandler.BLOCK, PARTS_ASSEMBLER.get(), (blockEntity, side) -> new net.crystalnexus.assembly.AssemblyLineItemHandler(blockEntity, side));
		event.registerBlockEntity(Capabilities.EnergyStorage.BLOCK, PARTS_ASSEMBLER.get(), (blockEntity, side) -> ((PartsAssemblerBlockEntity) blockEntity).getEnergyStorage());
		...
		event.registerBlockEntity(Capabilities.ItemHandler.BLOCK, CIRCUIT_PRESS.get(), (blockEntity, side) -> new net.crystalnexus.assembly.AssemblyLineItemHandler(blockEntity, side));
		...
		event.registerBlockEntity(Capabilities.FluidHandler.BLOCK, CIRCUIT_PRESS.get(), (blockEntity, side) ->
			((CircuitPressBlockEntity) blockEntity).getNitrogenTank());
		...
		event.registerBlockEntity(Capabilities.EnergyStorage.BLOCK, CHLOROPHYTE_SOLAR_PANEL.get(), (blockEntity, side) -> ((ChlorophyteSolarPanelBlockEntity) blockEntity).getEnergyStorage());
		...
		event.registerBlockEntity(Capabilities.ItemHandler.BLOCK, MEGA_CHEMICAL_REACTION_CHAMBER.get(), (blockEntity, side) -> new SidedInvWrapper((WorldlyContainer) blockEntity, side));
		event.registerBlockEntity(Capabilities.EnergyStorage.BLOCK, MEGA_CHEMICAL_REACTION_CHAMBER.get(), (blockEntity, side) -> ((MegaChemicalReactionChamberBlockEntity) blockEntity).getEnergyStorage());
		event.registerBlockEntity(Capabilities.FluidHandler.BLOCK, MEGA_CHEMICAL_REACTION_CHAMBER.get(), (blockEntity, side) -> ((MegaChemicalReactionChamberBlockEntity) blockEntity).getFluidHandler());
		...
		event.registerBlockEntity(Capabilities.EnergyStorage.BLOCK, MACHINE_ENERGY_OUTPUT.get(), (blockEntity, side) -> ((MachineEnergyOutputBlockEntity) blockEntity).getEnergyStorage());
		...
		event.registerBlockEntity(Capabilities.ItemHandler.BLOCK, CRYSTAL_TANK.get(), (blockEntity, side) -> new SidedInvWrapper((WorldlyContainer) blockEntity, side));
		event.registerBlockEntity(Capabilities.FluidHandler.BLOCK, CRYSTAL_TANK.get(), (blockEntity, side) -> ((CrystalTankBlockEntity) blockEntity).getFluidTank());
		...
		event.registerBlockEntity(Capabilities.ItemHandler.BLOCK, SOLAR_SIMULATOR_CONTROLLER.get(), (blockEntity, side) ->
			new net.crystalnexus.block.entity.SolarSimulatorItemHandler((net.crystalnexus.block.entity.SolarSimulatorControllerBlockEntity) blockEntity, side));
