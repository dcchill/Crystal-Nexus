...
import net.crystalnexus.block.CrystalGloopBlock;
...
public class CrystalnexusModBlocks {
	...
	public static final DeferredBlock<Block> CRYSTAL_GLOOP = REGISTRY.register("crystal_gloop", CrystalGloopBlock::new);
	public static final DeferredBlock<Block> GROWTH_CHAMBER = REGISTRY.register("growth_chamber", GrowthChamberOffBlock::new);
