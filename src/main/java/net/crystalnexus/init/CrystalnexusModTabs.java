...
public class CrystalnexusModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CRYSTAL_NEXUS_TAB = REGISTRY.register("crystal_nexus_tab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.crystalnexus.crystal_nexus_tab")).icon(() -> new ItemStack(CrystalnexusModItems.ANCIENT_CRYSTAL.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(CrystalnexusModBlocks.MULTIBLOCK_FLUID_OUTPUT.get().asItem());
				...
				tabData.accept(CrystalnexusModBlocks.ILMENITE_ORE.get().asItem());
				...
				tabData.accept(CrystalnexusModItems.ACIDIC_SLURRY_BUCKET.get());
				tabData.accept(CrystalnexusModItems.RESIN_BUCKET.get());
				...
				tabData.accept(CrystalnexusModBlocks.GROWTH_ACCELERATOR.get().asItem());
				tabData.accept(CrystalnexusModBlocks.REFINERY.get().asItem());
				...
				tabData.accept(CrystalnexusModBlocks.TITANIUM_EXTRACTINATOR.get().asItem());
				...
				tabData.accept(CrystalnexusModBlocks.TITANIUM_CRUSHER.get().asItem());
				tabData.accept(CrystalnexusModBlocks.TITANIUM_DUST_SEPARATOR.get().asItem());
				tabData.accept(CrystalnexusModBlocks.TITANIUM_REFINERY.get().asItem());
				tabData.accept(CrystalnexusModBlocks.AOE_CHARGER.get().asItem());
				tabData.accept(CrystalnexusModBlocks.TITANIUM_SMELTER.get().asItem());
				...
				tabData.accept(CrystalnexusModItems.TITANIUM_PICKAXE.get());
				tabData.accept(CrystalnexusModItems.TITANIUM_AXE.get());
				tabData.accept(CrystalnexusModItems.TITANIUM_SWORD.get());
				tabData.accept(CrystalnexusModItems.TITANIUM_SHOVEL.get());
				tabData.accept(CrystalnexusModItems.TITANIUM_HOE.get());

				// Age 3 - Carbon Fiber, Titanium Carbide, and Tungsten
				...
				tabData.accept(CrystalnexusModBlocks.TUNGSTEN_CRUSHER.get().asItem());
				tabData.accept(CrystalnexusModBlocks.TUNGSTEN_DUST_SEPARATOR.get().asItem());
				tabData.accept(CrystalnexusModBlocks.TUNGSTEN_REFINERY.get().asItem());
				...
				tabData.accept(CrystalnexusModBlocks.TUNGSTEN_SMELTER.get().asItem());
				...
				tabData.accept(CrystalnexusModItems.WOLFRAMITE.get());
				...
				tabData.accept(CrystalnexusModItems.CARBON_FE_EFFICIENCY_UPGRADE.get());
				...
				// Age 4 - Solar, Hyper, and Zero Point
				tabData.accept(CrystalnexusModBlocks.PLASMA_BLOCK.get().asItem());
				tabData.accept(CrystalnexusModBlocks.HYPER_LASER_QUARRY.get().asItem());
				...
				tabData.accept(CrystalnexusModItems.EMERALD_SINGULARITY.get());
				...
				tabData.accept(CrystalnexusModItems.WOOD_SINGULARITY.get());
				tabData.accept(CrystalnexusModItems.STONE_SINGULARITY.get());
				tabData.accept(CrystalnexusModItems.DIRT_SINGULARITY.get());
				...
				tabData.accept(CrystalnexusModBlocks.BLACK_HOLE_TNT.get().asItem());
				tabData.accept(CrystalnexusModItems.ORBITAL_STRIKE_REMOTE.get());
			}).build());
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CRYSTAL_NEXUS_LOGISTICS = REGISTRY.register("crystal_nexus_logistics",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.crystalnexus.crystal_nexus_logistics")).icon(() -> new ItemStack(CrystalnexusModBlocks.CONVEYER_BELT.get())).displayItems((parameters, tabData) -> {
				...
				// Age 2
				tabData.accept(CrystalnexusModBlocks.TITANIUM_CONVEYER_BELT.get().asItem());
				tabData.accept(CrystalnexusModBlocks.ENERGY_CABLE_MK_2.get().asItem());

				// Age 3
				tabData.accept(CrystalnexusModBlocks.METEORITE_CONVEYER_BELT.get().asItem());
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CRYSTAL_NEXUS_BUILDING_BLOCKS = REGISTRY.register("crystal_nexus_building_blocks",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.crystalnexus.crystal_nexus_building_blocks")).icon(() -> new ItemStack(CrystalnexusModBlocks.HEAVY_IRON_BLOCK.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(CrystalnexusModBlocks.INSULATED_TITANIUM_CASING.get().asItem());
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CRYSTAL_NEXUS_MACHINES = REGISTRY.register("crystal_nexus_machines",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.crystalnexus.crystal_nexus_machines")).icon(() -> new ItemStack(CrystalnexusModBlocks.PARTS_ASSEMBLER.get())).displayItems((parameters, tabData) -> {
				// Starter
				tabData.accept(CrystalnexusModBlocks.IRON_SMELTER.get().asItem());
				tabData.accept(CrystalnexusModBlocks.PARTS_ASSEMBLER.get().asItem());
				tabData.accept(CrystalnexusModBlocks.BLOCK_PLACER.get().asItem());
