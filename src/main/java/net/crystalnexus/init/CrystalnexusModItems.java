...
import net.crystalnexus.item.RawIlmeniteItem;
...
import net.crystalnexus.item.TitaniumSwordItem;
import net.crystalnexus.item.TitaniumShovelItem;
import net.crystalnexus.item.TitaniumSheetItem;
import net.crystalnexus.item.TitaniumIngotItem;
import net.crystalnexus.item.MeteoriteSheetItem;
import net.crystalnexus.item.TitaniumPickaxeItem;
import net.crystalnexus.item.TitaniumHoeItem;
import net.crystalnexus.item.TitaniumAxeItem;
...
import net.crystalnexus.item.CarbonCompositeItem;
...
import net.crystalnexus.item.FEEfficiencyUpgradeItem;
...
import net.crystalnexus.item.CarbonFEEfficiencyUpgradeItem;
...
public class CrystalnexusModItems {
	...
	public static final DeferredItem<Item> TITANIUM_HAMMER = REGISTRY.register("azurine_hammer", TitaniumHammerItem::new);
	...
	public static final DeferredItem<Item> CHLOROPHYTE_DUST_SEPARATOR = block(CrystalnexusModBlocks.CHLOROPHYTE_DUST_SEPARATOR);
	public static final DeferredItem<Item> INVERTIUM_DUST_SEPARATOR = block(CrystalnexusModBlocks.INVERTIUM_DUST_SEPARATOR);
	...
	public static final DeferredItem<Item> TITANIUM_MACHINE_FRAME = block(CrystalnexusModBlocks.TITANIUM_MACHINE_FRAME);
	...
	public static final DeferredItem<Item> TUNGSTEN = REGISTRY.register("obsidrax", () -> new Item(new Item.Properties()));
	public static final DeferredItem<Item> TUNGSTEN_BLOCK = block(CrystalnexusModBlocks.TUNGSTEN_BLOCK);
	public static final DeferredItem<Item> TUNGSTEN_SHEET = REGISTRY.register("obsidrax_sheet", () -> new Item(new Item.Properties()));
	public static final DeferredItem<Item> TUNGSTEN_MACHINE_FRAME = block(CrystalnexusModBlocks.TUNGSTEN_MACHINE_FRAME);
	...
	public static final DeferredItem<Item> TITANIUM_CARBIDE_GLASS = block(CrystalnexusModBlocks.TITANIUM_CARBIDE_GLASS);
	...
	public static final DeferredItem<Item> CARBON_FE_EFFICIENCY_UPGRADE = REGISTRY.register("carbon_fe_efficiency_upgrade", CarbonFEEfficiencyUpgradeItem::new);
	...
	public static final DeferredItem<Item> TUNGSTEN_ROD = REGISTRY.register("obsidrax_rod", () -> new Item(new Item.Properties()));
	...
	public static final DeferredItem<Item> AZURINE_HEATING_CORE = block(CrystalnexusModBlocks.AZURINE_HEATING_CORE);
	...
	public static final DeferredItem<Item> TITANIUM_BEARING = REGISTRY.register("azurine_bearing", () -> new Item(new Item.Properties()));
	public static final DeferredItem<Item> TITANIUM_CARBIDE_BEARING = REGISTRY.register("ferrosteel_bearing", () -> new Item(new Item.Properties()));
	public static final DeferredItem<Item> ELECTRIC_MOTOR = REGISTRY.register("electric_motor", () -> new Item(new Item.Properties()));
	public static final DeferredItem<Item> TITANIUM_ELECTRIC_MOTOR = REGISTRY.register("azurine_electric_motor", () -> new Item(new Item.Properties()));
	...
	public static final DeferredItem<Item> RAW_ILMENITE = REGISTRY.register("raw_azurine", RawIlmeniteItem::new);
	public static final DeferredItem<Item> ILMENITE_ORE = block(CrystalnexusModBlocks.ILMENITE_ORE);
	public static final DeferredItem<Item> DEEPSLATE_ILMENITE_ORE = block(CrystalnexusModBlocks.DEEPSLATE_ILMENITE_ORE);
	public static final DeferredItem<Item> CONTAINER = block(CrystalnexusModBlocks.CONTAINER);
	...
	public static final DeferredItem<Item> TITANIUM_PICKAXE = REGISTRY.register("azurine_pickaxe", TitaniumPickaxeItem::new);
	public static final DeferredItem<Item> TITANIUM_AXE = REGISTRY.register("azurine_axe", TitaniumAxeItem::new);
	public static final DeferredItem<Item> TITANIUM_SWORD = REGISTRY.register("azurine_sword", TitaniumSwordItem::new);
	public static final DeferredItem<Item> TITANIUM_SHOVEL = REGISTRY.register("azurine_shovel", TitaniumShovelItem::new);
	public static final DeferredItem<Item> TITANIUM_HOE = REGISTRY.register("azurine_hoe", TitaniumHoeItem::new);
	public static final DeferredItem<Item> TITANIUM_BLOCK = block(CrystalnexusModBlocks.TITANIUM_BLOCK);
	...
	public static final DeferredItem<Item> CARBON_COMPOSITE = REGISTRY.register("carbon_composite", CarbonCompositeItem::new);
	...
	public static final DeferredItem<Item> ACIDIC_SLURRY_BUCKET = REGISTRY.register("acidic_slurry_bucket",
			() -> new BucketItem(CrystalnexusModFluids.ACIDIC_SLURRY.get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
	public static final DeferredItem<Item> RESIN_BUCKET = REGISTRY.register("resin_bucket",
			() -> new BucketItem(CrystalnexusModFluids.RESIN.get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
	...
	public static final DeferredItem<Item> TITANIUM_CONVEYER_BELT = block(CrystalnexusModBlocks.TITANIUM_CONVEYER_BELT);
	public static final DeferredItem<Item> METEORITE_CONVEYER_BELT = block(CrystalnexusModBlocks.METEORITE_CONVEYER_BELT);
	...
	public static final DeferredItem<Item> COPPER_MACHINE_BOLT = REGISTRY.register("copper_machine_bolt", () -> new Item(new Item.Properties()));
	...
	public static final DeferredItem<Item> SINGULARITY_MATRIX = block(CrystalnexusModBlocks.SINGULARITY_MATRIX);
	...
	public static final DeferredItem<Item> HYPER_LASER_QUARRY = block(CrystalnexusModBlocks.HYPER_LASER_QUARRY);
	...
	public static final DeferredItem<Item> GEIGER_COUNTER = REGISTRY.register("geiger_counter", GeigerCounterItem::new);
	...
	public static final DeferredItem<Item> FACTORY_LIGHT_FLOOR = block(CrystalnexusModBlocks.FACTORY_LIGHT_FLOOR);
	public static final DeferredItem<Item> WHITE_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.WHITE_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> ORANGE_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.ORANGE_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> MAGENTA_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.MAGENTA_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> LIGHT_BLUE_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.LIGHT_BLUE_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> YELLOW_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.YELLOW_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> LIME_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.LIME_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> PINK_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.PINK_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> GRAY_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.GRAY_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> LIGHT_GRAY_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.LIGHT_GRAY_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> CYAN_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.CYAN_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> PURPLE_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.PURPLE_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> BLUE_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.BLUE_HEAVY_IRON_BLOCK);
	public static final DeferredItem<Item> BROWN_HEAVY_IRON_BLOCK = block(CrystalnexusModBlocks.BROWN_HEAVY_IRON_BLOCK);
