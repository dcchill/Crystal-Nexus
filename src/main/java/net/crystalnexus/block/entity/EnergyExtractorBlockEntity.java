...
public class EnergyExtractorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("energy_extractor");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new EnergyExtractorGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(CrystalnexusConfig.MACHINES.ENERGY_EXTRACTOR.capacity(), CrystalnexusConfig.MACHINES.ENERGY_EXTRACTOR.maxReceive(), CrystalnexusConfig.MACHINES.ENERGY_EXTRACTOR.maxExtract(), 0) {
		@Override
