...
public class MatterTransmutationTableBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public static void tick(Level level, BlockPos pos, BlockState state, MatterTransmutationTableBlockEntity blockEntity) {
		if (level.isClientSide())
			return;
		MatterTransmutationTableOnTickUpdateProcedure.execute(level, pos.getX(), pos.getY(), pos.getZ());
	}
	...
	public Component getDefaultName() {
		return Component.literal("matter_transmutation_table");
	}

	@Override
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new MatterTransmutationGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
