...
public class GrowthChamberOffBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(2, ItemStack.EMPTY);

	public GrowthChamberOffBlockEntity(BlockPos position, BlockState state) {
		super(CrystalnexusModBlockEntities.GROWTH_CHAMBER.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new GrowthChamberGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(10240, 512, 512, 0) {
		@Override
