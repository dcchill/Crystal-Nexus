...
public class CrystalCrusherBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("crystal_crusher");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Crystal Ore Crusher");
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(MachineAge.from(getBlockState()).minimumCapacity(CrystalnexusConfig.MACHINES.CRYSTAL_CRUSHER.capacity(), 4096), CrystalnexusConfig.MACHINES.CRYSTAL_CRUSHER.maxReceive(), CrystalnexusConfig.MACHINES.CRYSTAL_CRUSHER.maxExtract(), 0) {
		@Override
