...
public class CraftingFactoryBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("crafting_factory");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CraftingFactoryGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
