...
public class ReactionChamberComputerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ReactionChamberComputerBlockEntity(BlockPos position, BlockState state) {
		super(CrystalnexusModBlockEntities.REACTION_CHAMBER_COMPUTER.get(), position, state);
	}

	public static void tick(Level level, BlockPos pos, BlockState state, ReactionChamberComputerBlockEntity blockEntity) {
		if (level.isClientSide())
			return;
		ReactionComputerOnTickUpdateProcedure.execute(level, pos.getX(), pos.getY(), pos.getZ());
	}
	...
	public Component getDefaultName() {
		return Component.literal("reaction_chamber_computer");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Reaction Chamber Computer");
	}
