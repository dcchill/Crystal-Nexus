...
public class ExtractinatorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ExtractinatorGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(CrystalnexusConfig.MACHINES.EXTRACTINATOR.capacity(), CrystalnexusConfig.MACHINES.EXTRACTINATOR.maxReceive(), CrystalnexusConfig.MACHINES.EXTRACTINATOR.maxExtract(), 0) {
		@Override
