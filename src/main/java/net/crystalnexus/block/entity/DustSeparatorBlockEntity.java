...
public class DustSeparatorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("dust_separator");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new SeparatorGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Crystal Dust Separator");
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(MachineAge.from(getBlockState()).minimumCapacity(CrystalnexusConfig.MACHINES.DUST_SEPARATOR.capacity(), 4096), CrystalnexusConfig.MACHINES.DUST_SEPARATOR.maxReceive(), CrystalnexusConfig.MACHINES.DUST_SEPARATOR.maxExtract(), 0) {
		@Override
