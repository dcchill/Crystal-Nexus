...
public class PistonGeneratorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public PistonGeneratorBlockEntity(BlockPos position, BlockState state) {
		super(CrystalnexusModBlockEntities.PISTON_GENERATOR.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("piston_generator");
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(CrystalnexusConfig.MACHINES.PISTON_GENERATOR.capacity(), CrystalnexusConfig.MACHINES.PISTON_GENERATOR.maxReceive(), CrystalnexusConfig.MACHINES.PISTON_GENERATOR.maxExtract(), 0) {
		@Override
