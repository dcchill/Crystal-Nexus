...
public class SingularityCompressorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public static void tick(Level level, BlockPos pos, BlockState state, SingularityCompressorBlockEntity blockEntity) {
	...
	public Component getDefaultName() {
		return Component.literal("singularity_compressor");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new SingularityCompressorGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
