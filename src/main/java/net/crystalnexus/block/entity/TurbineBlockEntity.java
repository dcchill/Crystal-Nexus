...
public class TurbineBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public TurbineBlockEntity(BlockPos position, BlockState state) {
		super(CrystalnexusModBlockEntities.TURBINE.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new TurbineGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(10480, 4096, 8192, 0) {
		@Override
