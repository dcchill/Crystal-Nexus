...
public class ContainerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ContainerBlockEntity(BlockPos position, BlockState state) {
		super(CrystalnexusModBlockEntities.CONTAINER.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ContainerGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
